...
public class A3RepoImpl implements A3Repo {
    ...
    public List<A3User> getAll() {
        ...
        try {
            ...
            while (result.next()) {
                ...
                a3User.setId(result.getString("userID"));
                ...
                a3User.setDistrictID(result.getString("districtID"));
                a3User.setA2Userid(result.getString("a2_userID"));
    ...
    @Override
    public A3User getById(String id) {
        Connection conn = connection.getConnection();
        A3User a3User = null;
        try {
            String query = "select * from citizen_db.a3_user a3 inner join citizen_db.user u on u.userID = a3.userID " +
    ...
    public void createUser(A3Register register) {
        ...
        try {
            ...
            statement.setString(3, register.getDistrictID());
    ...
    public void updateUser(A3User a3User) {
        ...
        try {
            ...
            statement.setString(2, a3User.getDistrictID());
            statement.setString(3, a3User.getA2Userid());
            statement.setString(4, a3User.getId());
            statement.execute();
            User user = new User();
